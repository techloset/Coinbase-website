            ...
            <footer className="text-white body-font bg-gray-900" >
                <div className="container px-5 py-24 mx-auto text-left flex  md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto  text-center md:text-left">
                        ...
                        <p className="mt-2 text-sm leading-7 text-gray-400"> Fusce ut elit aliquet, fermentum leo vel, tempus nunc. Fusce eu rhoncus augue.
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav classNameName="list-none mb-10 text-sm ">
                                <ol>
                                    ...
                                    <a className="text-gray-300 leading-10 text-sm hover:text-gray-400">Home</a>
                                </ol>
                                <ol>
                                    <a className="text-gray-300 leading-10 text-sm hover:text-gray-400">About Us</a>
                                </ol>
                                <ol>
                                    <a className="text-gray-300 leading-10 text-sm hover:text-gray-400">Blog</a>
                                </ol>
                                <ol>
                                    <a className="text-gray-300 leading-10 text-sm hover:text-gray-400">Sell</a>
                                </ol>
                                <ol>
                                    <a className="text-gray-300 leading-10 text-sm hover:text-gray-400">Contact Us</a>
                                </ol>
                            </nav>
                        </div>
                        <div className="lg:w-1/4  md:w-1/2 w-full px-4">
                ...
                <div className="bg-gray-100">
                    <div className="container mx-auto py-4 px-5 flex  flex-col sm:flex-row">
                        <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Designed —
                            <a href="" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@ Cr8tiv_yemmy</a>
                        </p>
