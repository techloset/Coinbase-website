        ...
        <> 
            ...
            <div className="flex justify-center  items-center   bg-no-repeat  bg-cover h-[50%] md:bg-center"  >
                <div className="flex flex-col justify-center items-center text-center  max-w-7xl pt-56 pb-20 px-10">
                    ...
                    <img src={line} alt="" />
                    <p className="mt-4 text-base md:w-[60%] font-normal text-[#333333]  leading-10">Subscribe to our newsletter for daily/weekly update of our products and services.</p>
                    <div className="sm:flex sm:flex-row gap-4 w-full sm:justify-center mt-11 sm:items-center flex flex-col justify-center items-center">
                        ...
                        <button className="inline-flex text-white border-0 py-[17px] px-[33px] h-fit w-fit focus:outline-none rounded-full text-sm sm:text-[14px] leading-[21px]"
