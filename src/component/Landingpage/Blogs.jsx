    ...
    <div>
      ...
      <section className="text-gray-600 flex justify-center   body-font">
        <div className="container  py-24 ">
          <div className="flex flex-wrap justify-center items-center pl-">
            <div className="p-4 lg:w-1/3 ">
              <div className="sm:h-96 sm:w-96  h-56 w-64 bg-white-100 z-10 bg-white   border-gray-400 border   sm:px-8 sm:pt-10 sm:pb-24  rounded-xl overflow-hidden text-center relative">
                ...
                <div className='flex flex-col ml-4 sm:gap-5 mt-3'>
                  <h1 className="tracking-normal sm:text-2xl text-gray-400  text-left font-bold  space-x-1 sm:mt-3 sm:mb-3">
            ...
            <div className="p-4 lg:w-1/3 ">
              <div className="sm:h-96 sm:w-96 h-56 w-60 transform scale-125 z-20 bg-white shadow-xl border-fuchsia-800 border pl-5 sm:px-8 sm:pt-10 pt-2  sm:pb-24 rounded-lg overflow-hidden text-center relative">
                <div className='flex flex-row  sm:gap-2 sm:ml-4 gap-3  text-sm'>

                  <p>19 JUNE, 2019</p>
                  <div className='border-l-2 h-5 border-black '></div>
                  <p >BUSINESS</p>
                </div>
                <div className='flex flex-col ml- mt-2 sm:gap-5 gap-3 '>

                  <h1 className=" sm:text-2xl bg-gradient-to-b from-[#C35B95] to-[#B254AB] text-transparent bg-clip-text    text-md text-left font-bold mt-1 sm:mt-3 mb-3">ETH TO NAIRA EXCHANGE RATE IS NOW #400 PER...</h1>
                  <p className=" text-start ">Lorem ipsum dolor sit amet, magna habemus
                    ius ad, qui minimum voluptaria in. Ad mei modus
                    quodsi complectitur, postea...</p>
            ...
            <div className="p-4 lg:w-1/3 ">
              <div className="sm:h-96 sm:w-96 h-56 w-64  bg-white-100  border-gray-400 border  bg-opacity-75 sm:px-8 sm:pt-10 sm:pb-24 rounded-xl overflow-hidden text-center relative">
                ...
                <div className='flex flex-col ml-6 sm:gap-5 mt-3'>
                  <h1 className="tracking-normal sm:text-2xl text-gray-400  text-left font-bold  space-x-1 sm:mt-3 sm:mb-3">
