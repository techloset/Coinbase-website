    ...
    <>
      ...
      <div className='flex text-center justify-center mt-10'>
        ...
        <div className="  pt-[6rem] flex flex-row justify-center items-center mx-[5rem]">
              ...
              <div className=" transform max-lg:w-[80%]  scale-125 z-20 bg-white shadow-xl border-fuchsia-800 border sm:px-8 pb-[27px]  sm:pt-10  rounded-lg overflow-hidden text-center ">
                <div className='flex flex-row  sm:gap-2 ml-[30px] mt-[10px]  gap-3 font-norml text-sm'>
                ...
                <div className='flex flex-col ml-[30px]  sm:gap-5 gap-3 '>
                  ...
                  <p className=" text-start text-sm text-black leading-[20px]">Lorem ipsum dolor sit amet, magna habemus
                    ius ad, qui minimum voluptaria in. Ad mei modus
                    quodsi complectitur, postea...</p>
