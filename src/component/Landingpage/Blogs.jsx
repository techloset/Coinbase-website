...
const Blogs = () => {
  return (
    <>
      ...
      <div className='flex text-center flex-col  justify-center md:mt-[8.875rem]'>

        <h4 className="font-poppins font-bold text-[28px] leading-[42px] bg-gradient-to-b from-[#C35B95] to-[#B254AB]
      ...
      <div className='flex text-center justify-center w-[90%] pl-[10%] mt-4 md:mt-10'>
        <h4 className="font-poppins text-base font-normal sm:leading-10   text-[#333333]">
          Get to know the latest stuff via our blog post.
        </h4>
      </div>
        <div className="md:mt-[6rem] mt-[3rem] flex flex-row justify-center items-center xl:mx-[13rem] lg:mx-[7rem] sm:mx-[6rem]">
         
              <div className=" bg-white-100 z-10 bg-white max-lg:hidden lg:block   border-gray-400 border    sm:pt-10 pb-[27px] rounded-xl overflow-hidden text-center ">
                ...
                <div className='flex flex-col ml-[40px] sm:gap-3 '>
                  <h1 className="tracking-normal sm:text-xl text-gray-400  text-left font-bold  sm:mt-3 sm:mb-3">
              ...
              <div className=" transform w-[60%] sm:w-[85%] lg:w-[1200px] xl:w-[85%]  scale-125 z-20 bg-white shadow-xl border-fuchsia-800 border pb-[27px]  sm:pt-10  rounded-lg overflow-hidden text-center ">
              ...
              <div className="  bg-white-100 max-lg:hidden lg:block  border-gray-400 border  bg-opacity-75 sm:pt-10 pb-[27px] rounded-xl overflow-hidden text-center ">
