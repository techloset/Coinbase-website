  ...
  return (
    <>
      ...
      <div class="flex justify-center items-center">
        <div class="my-container text-center w-[60%] ">
          <p className='leading-7 gap-y-6 font-normal text-sm text-justify '>But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.
            But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human happiness.
          </p>

          <br />
          <p className='leading-7 gap-y-6 font-normal text-sm text-justify '>Planning Your Luxury Trip</p>
          <br />
          <p className='leading-7 gap-y-6 font-normal text-sm text-justify'> But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born
          ...
          <br />
          <p className='leading-7 gap-y-6 font-normal text-sm text-justify'>
          ...
          <div className='flex flex-row '>
            <div className=''>
              <p className='leading-7 gap-y-6 font-normal text-sm text-start w-[70%]'>
                If you like the idea of knowing what it is really like to sail, but don’t want to risk safety,
              ...
              <br />
              <p className='leading-7 gap-y-6 font-normal text-sm text-start w-[70%]'>
                Destinations & Ports of important Charter Companies  One of the greatest benefits of choosing
                ...
                if you want to add or subtract stops along the way.
              </p>
            </div>
            <img src="navimg/Reference IMG.png" className='w-[100%] h-[100%]' alt="" />
          </div>
          ...
          <div className='flex flex-row justify-between my-9'>
            <h1 className='font-Poppins font-bold text-sm'>Tags: Business, Capital, Finance</h1>
          ...
          <div className='flex justify-between '>
            ...
            <div>
              ...
              <h1 className='font-Poppins font-bold text-md text-end bg-gradient-to-b from-[#FD749B] to-[#281AC8] text-transparent 
        bg-clip-text cursor-pointer '>Exchange 5 products <br /> and get 1 free product</h1>
              <p className='font-Poppins leading-10 text-xs text-end'>Next Post</p>
            </div>
          </div>
      ...
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-start  w-full mb-12">
            <h1 className="sm:text-3xl text-xl font-bold pl-52 title-font mb-4 text-gray-900">Leave A Comment</h1>
