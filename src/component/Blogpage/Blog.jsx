    ...
    <>
      ...
      <div className=" mx-auto flex w-2/3 sm:w-5/6   sm:py-16    flex-col ">
        ...
        <div className=" flex justify-center gap-3 flex-col text-center h-[70%] py-5 sm:py-16 rounded-b-3xl border-l-2 border-r-2 border-b-2 border-fuchsia-600">
          ...
          <div className="flex justify-center">
            <button className="inline-flex font-bold text-[14px] py-[17px] px-[33px] leading-5 text-white border-0  focus:outline-none rounded-full text-lg" style={{ background: 'linear-gradient(178.18deg, #FD749B -13.56%, #281AC8 158.3%)' }}>DISCOVER</button>
          </div>
        </div>
      </div>
      ...
      <div className=" mx-auto flex w-2/3 sm:w-5/6  py-10 sm:py-16    flex-col ">
        ...
        <div className=" flex justify-center gap-5 flex-col text-center h-[70%] py-5 sm:py-16 rounded-b-3xl border-l-2 border-r-2 border-b-2 border-fuchsia-600">
          ...
          <div className="flex justify-center">
            <button className="inline-flex text-white border-0 font-bold text-[14px] py-[17px] px-[33px] leading-5 focus:outline-none rounded-full text-lg" style={{ background: 'linear-gradient(178.18deg, #FD749B -13.56%, #281AC8 158.3%)' }}>DISCOVER</button>
          </div>
        </div>
      ...
      <div className='flex flex-row justify-center items-center gap-3 py-14 h-full'>
        <button className='rounded-full text-lg text-[#FFFFFF] w-14 h-14' style={{ background: 'linear-gradient(178.18deg, #FD749B -13.56%, #281AC8 158.3%)' }}>01</button>
